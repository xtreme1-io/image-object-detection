...
#         t_size = cv2.getTextSize(label.split(u"_@_")[0], 0, fontScale=tl / 3, thickness=tf)[0]
        t_size = cv2.getTextSize(label.split(u"_@_")[0], 0, fontScale=font_scale, thickness=1)[0]
        c2 = c1[0] + t_size[0], c1[1] - t_size[1] - 3
        cv2.rectangle(img, c1, c2, color, -1, cv2.LINE_AA)  # filled
        cv2.putText(img, label.split(u"_@_")[0], (c1[0], c1[1] - 2), 0, font_scale, [225, 255, 255], thickness=1, lineType=cv2.LINE_AA)
